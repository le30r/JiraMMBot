...
data class TextareaElement(
    ...
    val type: String,//	Set this value to texareat for a textarea element.
    ...
    val max_length: Int?,//	(Optional) Maximum input length allowed for an element. Default is 3000.
    ...
    val default: String?,//	(Optional) Set a default value for this form element. Maximum 3000 characters.
    val placeholder: String?//	(Optional) A string displayed to help guide users in completing the element. Maximum 3000 characters.
)