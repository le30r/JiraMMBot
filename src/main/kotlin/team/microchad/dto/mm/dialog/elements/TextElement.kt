...
@Serializable
class TextElement(override val display_name: String, override val name: String) : DialogElement {
    override val type = "text"//	Set this value to text for a text element.
    val subtype: String? =
