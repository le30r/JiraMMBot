 ...
 * max_length (Optional) Maximum input length allowed for an element. Default is 150. If you expect the input to be greater 150 characters, consider using a textarea type element instead.
 ...
 * default    (Optional) Set a default value for this form element. Maximum 150 characters.
 * placeholder (Optional) A string displayed to help guide users in completing the element. Maximum 150 characters.
 */
